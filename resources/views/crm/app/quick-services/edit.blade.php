        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Quick Service</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="py-1 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Edit Quick Service</h4>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="{{ route('quick-services.update', $quickService->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text"
                                                       ...
                                                       id="service_name"
                                                       name="service_name"
                                                       value="{{ old('service_name', $quickService->name) }}"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="number"
                                                       ...
                                                       id="service_price"
                                                       name="service_price"
                                                       value="{{ old('service_price', $quickService->service_price) }}"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                @if($quickService->service_image)
                                                    <div class="mt-2">
                                                        <label class="form-label">Current Image:</label><br>
                                                        <img src="{{ asset($quickService->service_image) }}"
                                                             alt="{{ $quickService->name }}"
                                                             width="100"
                                                             class="img-thumbnail">
                                                    </div>
                                                @endif
                                            ...
                                            <div class="col-12">
                                                ...
                                                <textarea name="service_description"
                                                          ...
                                                          rows="3"
                                                          placeholder="Enter Service Description">{{ old('service_description', $quickService->service_description) }}</textarea>
