                    ...
                    <div class="card-body">
                        <div class="px-3">
                            ...
                            <div class="mt-3">
                                ...
                                <p>Joining Date {{ $customer->created_at }}</p>
                            </div>
                        </div>
                        ...
                        <div class="p-3 bg-body rounded">
                            ...
                            <ul class="list-group">
                                <li class="d-flex justify-content-between align-items-center flex-wrap gap-2 list-group-item">
                                    ...
                                    <span class="font-weight-bold">{{ $customer->first_name }}</span>
                                </li>
                                ...
                                <li class="d-flex justify-content-between align-items-center flex-wrap gap-2 list-group-item">
                                    ...
                                    <span class="font-weight-bold">{{ $customer->last_name }}</span>
                                </li>
                            ...
                            <table class="table table-hover table-nowrap align-middle">
                                ...
                                <tbody class="list form-check-all">
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <a href="{{ route('service-request.view-service') }}" aria-label="anchor"
