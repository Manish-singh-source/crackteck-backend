                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-xl-4 col-lg-6">
                                        ...
                                        'label' => 'Gender',
                                        'name' => 'gender',
                                        'options' => ["0" => "--Select Gender--", "Male" => "Male", "Female" => "Female"]
                                        ])
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6">
                                        ...
                                        'label' => 'Industry Type',
                                        'name' => 'gender',
                                        'options' => ["0" => "--Select Industry--", "1" => "Pharma", "2" => "School", "3" => "Manufacturing"]
                                        ])
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6">
                                        ...
                                        'label' => 'Lead Status',
                                        'name' => 'lead_status',
                                        'options' => ["0" => "--Select Lead Status--", "1" => "New", "2" => "Contacted", "3" => "Qualified", "4" => "Quoted", "5" => "Converted", "6" => "Lost"]
                                        ])
                                    </div>
                                </div>
                            </div>
