                        ...
                        <div class="card-body pt-0">
                            <ul class="nav nav-underline border-bottom pt-2" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active p-2" id="all_staff_tab" data-bs-toggle="tab" href="#all_staff"
                                        role="tab">
                                ...
                                <!-- <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link p-2" id="managers_tab" data-bs-toggle="tab"
                                            href="#managers" role="tab">
                                            <span class="d-block d-sm-none"><i
                                                    class="mdi mdi-sitemap-outline"></i></span>
                                            <span class="d-none d-sm-block">Managers</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link p-2" id="technicians_tab" data-bs-toggle="tab"
                                            href="#technicians" role="tab">
                            ...
                            <div class="tab-content text-muted">
                                ...
                                <div class="tab-pane pt-4" id="admins" role="tabpanel">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card shadow-none">
                                                <div class="card-body">
                                ...
                                <div class="tab-pane pt-4" id="managers" role="tabpanel">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card shadow-none">
