                            ...
                            <div class="card-body">
                                <div class="widget-first">
                                    ...
                                    <div class="d-flex align-items-center mb-1">
                                        ...
                                        <div>
                                            <p class="mb-2 text-dark fs-15 fw-medium">Total Warehouses</p>
                            ...
                            <div class="card-body">
                                <div class="widget-first">
                                    ...
                                    <div class="d-flex align-items-center mb-1">
                                        ...
                                        <div>
                                            <p class="mb-2 text-dark fs-15 fw-medium">Total Products</p>
                            ...
                            <div class="card-body">
                                <div class="widget-first">
                                    ...
                                    <div class="d-flex align-items-center mb-1">
                                        ...
                                        <div>
                                            <p class="mb-2 text-dark fs-15 fw-medium">Total Revenue</p>
                            ...
                            <div class="card-body">
                                <div class="widget-first">
                                    ...
                                    <div class="d-flex align-items-center mb-1">
                                        ...
                                        <div>
                                            <p class="mb-2 text-dark fs-15 fw-medium">Total Scrap Items</p>
        ...
        <div class="row">
                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title mb-0">Low Stack Items</h5>
                        </div>
                    </div>
                            ...
                            <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                <thead class="text-muted table-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="cursor-pointer">Available Stock</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>13</td>
                                        <td>
                                            <span class="badge bg-warning-subtle text-warning fw-semibold rounded-pill">Low Stock</span>
                                        </td>
                                        <td>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title mb-0">Orders Accuracy (June)</h5>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center fw-medium my-3">87% increase in Orders Accuracy.</div>
        ...
        <div class="row">
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="browservisiting1" class="apex-charts"></div>

                        <div class="text-center fw-medium my-3">50% Warehouse Full.</div>
                            ...
                            <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Hardware</td>
                                        <td>
                                            <span class="badge bg-danger-subtle text-danger fw-semibold rounded-pill">Out of Stock</span>
                                        </td>
                                        <td>
                                            <a aria-label="anchor" class="btn btn-icon btn-sm bg-primary-subtle me-1" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                                <i class="mdi mdi-pencil-outline fs-14 text-primary"></i>
