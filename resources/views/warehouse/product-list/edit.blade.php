                                                ...
                                                <div>
                                                    ...
                                                    @if ($product->invoice_pdf)
                                                        <small class="text-muted">Current:
                                                            {{ basename($product->invoice_pdf) }}</small>
                                                    @endif
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            @if ($product->main_product_image)
                                                <small class="text-muted">Current:
                                                    {{ basename($product->main_product_image) }}</small>
                                            @endif
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if ($product->additional_product_images)
                                                <small class="text-muted">Current:
                                                    {{ count($product->additional_product_images) }} images</small>
                                            @endif
                                            <div class="text-danger">Image Size Should Be 800x650</div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if ($product->datasheet_manual)
                                                <small class="text-muted">Current:
                                                    {{ basename($product->datasheet_manual) }}</small>
                                            @endif
                                        ...
                                        @foreach ($variationAttributes as $attribute)
                                            <div class="mb-3">
                                                ...
                                                <select id="variation_{{ $attribute->id }}"
                                                    name="variations[{{ $attribute->id }}][]" class="form-select w-100"
                                                    multiple>
                                                    @foreach ($attribute->values as $value)
                                                        <option value="{{ $value->id }}">{{ $value->attribute_value }}
                                                        </option>
                                                    @endforeach
                                                </select>
