                                                        ...
                                                        <tbody>
                                                            @forelse($products as $product)
                                                                <tr class="align-middle">
                                                                    ...
                                                                    <td>
                                                                        <span
                                                                            class="badge bg-info-subtle text-info">{{ $product->sku }}</span>
                                                                        @if ($product->hsn_code)
                                                                    ...
                                                                    <td>
                                                                        @if ($product->parentCategorie)
                                                                            <span
                                                                                class="badge bg-primary-subtle text-primary fw-semibold">{{ $product->parentCategorie->parent_categories }}</span>
                                                                        @endif
                                                                        @if ($product->subCategorie)
                                                                            <div class="small text-muted">
                                                                                {{ $product->subCategorie->sub_categorie }}</div>
                                                                        @endif
                                                                    </td>
                                                                    <td>
