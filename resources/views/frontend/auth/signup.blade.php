            ...
            <div class="col-xl-5 col-lg-6 col-md-8">
                <div class="tf-login-form">
                    <div class="tf-heading-section text-center mb-4">
                        ...
                        <p class="sub-heading">Join us and start shopping today</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('ecommerce.signup.post') }}" class="form-register">
                        @csrf
                        <fieldset class="name">
                    ...
                    <div class="text-center mt-4">
                        <p class="text-gray-600">
                            ...
                            <a href="{{ route('ecommerce.login') }}" class="text-primary fw-semibold">Sign in here</a>
                        </p>
                    </div>
                </div>
            </div>
