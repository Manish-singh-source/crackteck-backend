    ...
    <div class="container-fluid">
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            ...
            <div>
                ...
                <div class="modal fade attribute-value-edit" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header bg-light">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a aria-label="anchor" 
                                                                ...
                                                                data-bs-toggle="modal" data-bs-original-title="Edit" data-bs-target=".attribute-value-edit">
