                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div style="width: 100px;">
                                                                <img src="{{ asset('assets/images/gallery/1.jpg') }}" alt="Promo Banner" class="w-100">
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a aria-label="Edit" href="{{ route('promotional.banner.edit') }}" class="btn btn-icon btn-sm bg-warning-subtle me-1" data-bs-toggle="tooltip" data-bs-original-title="Edit">
