                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="sku" name="sku" required="" placeholder="Product SKU Code">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            'label' => 'Brand',
                                            'name' => 'brand',
                                            'options' => ["0" => "--Select--", "1" => "ZKTeco", "2" => "TP-Link", "3" => "Cisco", "4" => "D-Link"]
                                            ])
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="model" name="model" required="" placeholder="Product Model No.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="serial" name="serial" required="" placeholder="Product Serial No.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="serial" name="serial" required="" placeholder="Custom Product Serial No.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            'label' => 'Category',
                                            'name' => 'category',
                                            'options' => ["0" => "--Select--", "1" => "Biometric Attendance & Access Control System", "2" => "Cisco", "3" => "D-Link"]
                                            ])
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12  col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="brand_warranty_details" name="brand_warranty_details" required="" placeholder="Enter Brand Warranty">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12  col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="crackteck_warranty_details" name="crackteck_warranty_details" required="" placeholder="Enter Our Company Warranty">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-6 mb-2">
                                        <div>
                                            ...
                                            <input name="cost_price" id="cost_price" type="text" class="form-control" placeholder="Enter Cost Price" required="">
                                        </div>
                                    </div>
                                    <div class="col-6 mb-2">
                                        <div>
                                            <label for="selling_price" class="form-label">Selling Price <span class="text-danger">*</span></label>
                                            <input name="selling_price" id="selling_price" type="text" class="form-control" placeholder="Enter Selling Price" required="">
                                        </div>
                                    </div>
                                    <div class="col-6 mb-2">
                                        <div>
                                            <label for="discount_price" class="form-label">Discount Price <span class="text-danger">*</span></label>
                                            <input name="discount_price" id="discount_price" type="text" class="form-control" placeholder="Enter Discount Price" required="">
                                        </div>
                                    </div>
                                    <div class="col-6 mb-2">
                                        <div>
                                            <label for="tax" class="form-label">Tax (%) <span class="text-danger">*</span></label>
                                            <input name="tax" id="tax" type="text" class="form-control" placeholder="Enter Tax" required="">
                                        </div>
                                    </div>
                                    <div class="col-6 mb-2">
                                        <div>
                                            <label for="final_price" class="form-label">Final Price (after discount) </label>
                                            <input name="final_price" id="final_price" type="text" class="form-control" placeholder="Enter Final Price" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-6 mb-2">
                                        <div>
                                            ...
                                            <input name="stock" id="stock" type="text" class="form-control" placeholder="Enter Stock" required="">
                                    ...
                                    <div class="col-6 mb-2">
                                        <div>
                                            ...
                                            <input name="min_order_qty" id="min_order_qty" type="number" class="form-control" placeholder="Enter Minimum Order Quantity" required="">
                                        </div>
                                    </div>
                                    <div class="col-6 mb-2">
                                        <div>
                                            <label for="max_order_qty" class="form-label">Maximum Order Qty<span class="text-danger">*</span></label>
                                            <input name="max_order_qty" id="max_order_qty" type="number" class="form-control" placeholder="Enter Maximum Order Quantity" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-6 mb-2">
                                        <div>
                                            ...
                                            <input name="meta_title" id="meta_title" type="text" class="form-control" placeholder="Enter Meta Title" required="">
                                        </div>
                                    </div>
                                    <div class="col-6 mb-2">
                                        <div>
                                            <label for="meta_description" class="form-label">Meta Description <span class="text-danger">*</span></label>
                                            <input name="meta_description" id="meta_description" type="text" class="form-control" placeholder="Enter Meta Description" required="">
                                        </div>
                                    </div>
                                    <div class="col-6 mb-2">
                                        <div>
                                            <label for="meta_keywords" class="form-label">Meta Keywords<span class="text-danger">*</span></label>
                                            <input name="meta_keywords" id="meta_keywords" type="text" class="form-control" placeholder="Enter Meta Keywords" required="">
                                        </div>
                                    </div>
                                    <div class="col-6 mb-2">
                                        <div>
                                            <label for="url_slug" class="form-label">Product URL Slug <span class="text-danger">*</span></label>
                                            <input name="url_slug" id="url_slug" type="text" class="form-control" placeholder="Enter Product URL Slug" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input name="weight" id="weight" type="text" class="form-control" placeholder="Enter Weight" required="">
                                </div>
                                <div class="mt-3 mb-3">
                                    <label for="dimensions" class="form-label">Product Dimensions (L × W × H cm/mm)<span class="text-danger">*</span></label>
                                    <input name="dimensions" id="dimensions" type="text" class="form-control" placeholder="Enter Dimension" required="">
                                </div>
                                <div class="mt-3 mb-3">
                                    <label for="shipping_charges" class="form-label">Shipping Charges<span class="text-danger">*</span></label>
                                    <input name="shipping_charges" id="shipping_charges" type="text" class="form-control" placeholder="Enter Shipping Charges" required="">
                                </div>
                                <div class="mt-3 mb-3">
