                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-6">
                                        ...
                                        'options' => ["0" => "--Select--", "1" => "Full-time", "2" => "Part-time"]
                                        ])
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        'label' => 'Vehicle Type',
                                        'name' => 'vehicle_type',
                                        'options' => ["0" => "--Select--", "1" => "Bike", "2" => "Scooter", "3" => "Car", "4" => "Van"]
                                        ])
                                    </div>
                                ...
                                <form method="post" id="branch-form">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-6">
                                            ...
                                            'options' => ["0" => "--Select--", "1" => "Pending", "2" => "Completed"]
                                            ])
                                        </div>
