                                        ...
                                        <div class="mb-0 border-0 p-md-4 p-lg-0">
                                            <div class="mb-4 p-0 text-lg-start text-center">
                                                <!-- <div class="auth-brand">
                                                    <a class='logo logo-light' href='./crm/index.php'>
                                                        <span class="logo-lg">
                                                            <img src="assets/images/logo-light-3.png" alt="" height="24">
                                                        </span>
                                                    </a>
                                                    <a class='logo logo-dark' href='./crm/index.php'>
                                                        <span class="logo-lg">
                                            ...
                                            <div class="pt-0">
                                                <form action="./crm/index.php" class="my-4">
                                                    ...
                                                    <div class="form-group d-flex mb-3">
                                                        ...
                                                        <div class="col-sm-6 text-end">
                                                            <a class='text-muted fs-14' href='recover-password.php'>Forgot password?</a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="text-center text-muted">
                                                    <p class="mb-0">Don't have an account ?<a class='text-primary ms-2 fw-medium' href='signup.php'>Sing up</a></p>
                                                </div>
