    ...
    public function run(): void
    {
        ...
        DB::table('ecommerce_products')->insert([
            ...
            [
                ...
                'sku' => 'SKU48754',
                'meta_title' => 'Dell Inspiron 16',
                'meta_description' => '<p>16-inch display laptop</p>',
                'meta_keywords' => 'Dell, Laptop',
                'meta_product_url_slug' => 'dell-inspiron-16',
                'with_installation' => null,
                'company_warranty' => null,
                'ecommerce_short_description' => '<p>16-inch display laptop</p>',
                'ecommerce_full_description' => '<p>Dell Inspiron 16 with Intel i5 processor and 512GB SSD.</p>',
                'ecommerce_technical_specification' => '<p>Intel i5, 8GB RAM, 512GB SSD.</p>',
                'min_order_qty' => 1,
                'max_order_qty' => null,
                'product_weight' => null,
                'product_dimensions' => null,
                ...
                'ecommerce_status' => 'active',
                'total_sold' => 0,
                'created_at' => Carbon::parse('2025-10-01 10:30:35'),
                'updated_at' => Carbon::parse('2025-10-01 10:30:35'),
            ],
            [
                'id' => 6,
                'warehouse_product_id' => 5,
                'sku' => 'SKU48755',
                'meta_title' => 'HP EliteBook 840',
                'meta_description' => '<p>Business ultrabook</p>',
                'meta_keywords' => 'Apple, Laptop',
                'meta_product_url_slug' => 'hp-elitebook-840',
                'with_installation' => null,
                'company_warranty' => null,
                'ecommerce_short_description' => '<p>Business ultrabook</p>',
                'ecommerce_full_description' => '<p>HP EliteBook 840 with security features.</p>',
                'ecommerce_technical_specification' => '<p>Intel i5, 8GB RAM, 256GB SSD.</p>',
                'min_order_qty' => 1,
                'max_order_qty' => null,
                'product_weight' => null,
                ...
                'ecommerce_status' => 'active',
                'total_sold' => 0,
                'created_at' => Carbon::parse('2025-10-01 10:30:51'),
                'updated_at' => Carbon::parse('2025-10-01 10:30:51'),
            ],
        ]);
    }
}
