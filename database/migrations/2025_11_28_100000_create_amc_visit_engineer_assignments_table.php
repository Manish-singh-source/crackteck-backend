...
return new class extends Migration
{
    ...
    {
        Schema::create('amc_visit_engineer_assignments', function (Blueprint $table) {
            $table->id();
            $table->foreignId('visit_id')->constrained('amc_service_visits')->onDelete('cascade');
        ...
        Schema::create('amc_visit_group_engineers', function (Blueprint $table) {
            $table->id();
            $table->foreignId('assignment_id')->constrained('amc_visit_engineer_assignments')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('amc_visit_group_engineers');
        Schema::dropIfExists('amc_visit_engineer_assignments');
    }
};
