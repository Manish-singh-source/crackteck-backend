...
return new class extends Migration
{
    ...
    {
        Schema::create('amc_engineer_assignments', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('amc_group_engineers', function (Blueprint $table) {
            $table->id();
            $table->foreignId('assignment_id')->constrained('amc_engineer_assignments')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('amc_group_engineers');
        Schema::dropIfExists('amc_engineer_assignments');
    }
};
