                        ...
                        <div class="row g-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="en-input" type="text" name="name[en]" class="form-control" placeholder="Enter Name" value="" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-xl-12">
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-2">
                                            <label for="banner" class="form-label">Feature Image <span class="text-danger">*</span></label>
