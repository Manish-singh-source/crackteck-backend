                            ...
                            <form action="#" method="POST" enctype="multipart/form-data">
                                <div class="row g-3">
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control" placeholder="Enter Collection Title" value="" required="">
                                    </div>

                                    <div class="col-6">
                                        <label for="description" class="form-label">Description <span class="text-danger">*</span></label>
                                        <input type="text" name="description" id="description" class="form-control" placeholder="Enter Collection Description" value="" required="">
                                    </div>
