    ...
    <div class="h-100" data-simplebar>
        ...
        <div id="sidebar-menu">
            ...
            <ul id="side-menu">
                ...
                <!-- <li>
                    ...
                    <div class="collapse" id="accesscontrol">
                        <ul class="nav-second-level">
                            <li>
                                <a class='tp-link' href='staff.php'>Staff</a>
                            </li>
                            <li>
                                <a class='tp-link' href='roles.php'>Roles</a>
                            </li>
                        </ul>
                    </div>
                </li> -->
                ...
                <!-- <li>
                    <a class='tp-link' href='subcategories.php'>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarBaseui">
                        <ul class="nav-second-level">
                            <li>
                                <a class='tp-link' href='transactions.php'>Transactions</a>
                            </li>
                            <li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarBaseui1">
                        <ul class="nav-second-level">
                            <li>
                                <a class='tp-link' href='banner.php'>Website Banner</a>
                            </li>
                            <li>
                                <a class='tp-link' href='promotional-banner.php'>Promotional Banner</a>
                            </li>
