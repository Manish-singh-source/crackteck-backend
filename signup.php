                                        ...
                                        <div class="mb-0 border-0 p-md-4 p-lg-0">
                                            <div class="mb-4 p-0 text-lg-start text-center">
                                                <!-- <div class="auth-brand">
                                                    ...
                                                    <a class='logo logo-dark' href='./e-commerce/index.php'>
                                                        <span class="logo-lg">
                                            ...
                                            <div class="pt-0">
                                                ...
                                                <div class="text-center text-muted mb-0">
                                                    <p class="mb-0">Already have an account ?<a class='text-primary ms-2 fw-medium' href='index.php'>Login here</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
