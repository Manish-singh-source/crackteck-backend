                    ...
                    <div class="card-body">
                        <div class="widget-first">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <p class="mb-0 text-dark fs-15">Daily Follow Ups</p>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="widget-first">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <p class="mb-0 text-dark fs-15">Monthly Target Progress</p>
                            </div>

                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="mb-0 fs-22 text-dark me-3">78%</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="widget-first">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <p class="mb-0 text-dark fs-15">Open Leads</p>
                            </div>

                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="mb-0 fs-22 text-dark me-3">24</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="widget-first">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <p class="mb-0 text-dark fs-15">Quotation Sent</p>
                            </div>


                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="mb-0 fs-22 text-dark me-3">18</h3>
                    ...
                    <div class="card-body">
                        <div class="widget-first">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <p class="mb-0 text-dark fs-15">Total Revenue This Month</p>
                            </div>


                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="mb-0 fs-22 text-dark me-3">125,000</h3>
                        ...
                        <div class="table-responsive table-card mt-0">
                            <table
                                ...
                                <thead class="text-muted table-light">
                                    <tr>
                                        <th scope="col" class="cursor-pointer">Task</th>
                                        <th scope="col" class="cursor-pointer">Lead Name</th>
                                        <th scope="col" class="cursor-pointer">Due Date</th>
                                        <th scope="col" class="cursor-pointer">Sales Rep</th>
                                        <th scope="col" class="cursor-pointer">Priority</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-danger-subtle text-danger fw-semibold">High</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-primary-subtle text-primary fw-semibold">Low</span>
                                        </td>
                                        <td>
                                            <span
                                                class="badge bg-primary-subtle text-primary fw-semibold">Not Started</span>
                            ...
                            <table
                                ...
                                <thead class="text-muted table-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="cursor-pointer">Target</th>
                                        <th scope="col" class="cursor-pointer">Achieved</th>
                                        <th scope="col" class="cursor-pointer">% Completion</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title mb-0">Leads, Quotations, and Closures</h5>
                        </div>
                    </div>
                            ...
                            <table
                                ...
                                <thead class="text-muted table-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="cursor-pointer">Stage</th>
                                        <th scope="col" class="cursor-pointer">Quotation Status</th>
                                        <th scope="col" class="cursor-pointer">Expected Closure Date</th>
                                        <th scope="col" class="cursor-pointer">Value(₹)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                            ...
                            <table
                                ...
                                <thead class="text-muted table-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="cursor-pointer">Deal Value</th>
                                        <th scope="col" class="cursor-pointer">Stage</th>
                                        <th scope="col" class="cursor-pointer">Probability of Closing</th>
                                        <th scope="col" class="cursor-pointer">Owner</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
